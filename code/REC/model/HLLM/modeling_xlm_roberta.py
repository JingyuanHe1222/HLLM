...
class XLMRobertaSelfFlashAttention(XLMRobertaSelfAttention):
    def __init__(self, config, position_embedding_type=None):
    ...
    def forward(
        ...
        context_layer = attn_output.reshape(bsz, q_len, self.hidden_size)
...
XLM_ROBERTA_SELF_ATTENTION_CLASSES = {
    ...
    "flash_attention_2": XLMRobertaSelfFlashAttention
}
